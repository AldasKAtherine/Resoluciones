...
Route::get('/docentes', 'DocentesController@index')->middleware('auth', 'role:ADMINISTRADOR', 'banned');
...
Route::post('import-list-excel-docentesDOGC','DocentesController@importExcel')->middleware('auth', 'role:ADMINISTRADOR', 'banned')->name('docentes.import.excel');
