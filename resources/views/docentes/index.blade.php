            ...
            <div class="card">
                ...
                <div class="card-body" >
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                        @foreach( $docentes as $doente )
                            <tr>
                                
                                <td scope="col">{{$doente->cedula}}</td>
                                <td scope="col">{{$doente->titulo}} {{$doente->nombres}}</td>
                                <td scope="col">{{$doente->correo}}</td>
                                <td scope="col">{{$doente->telefono}}</td>
